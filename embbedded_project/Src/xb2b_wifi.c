...
BOOL CONFIGURATIONS_set_network(void){
	...
	if(!SYSTEM_CONTROL_set_up()){
		...
		USART2_write((uint8_t*)"\r\n\r\n");
		USART2_write((uint8_t*)("\033[96m\r\nIf you have previously created a user on the app,\r\nyou can set your device ID on the 'Settings' page.\033[0m"));
		USART2_write((uint8_t*)("\033[32m\r\nLog in here: https://project-cnss.web.app/login\033[0m"));
		USART2_write((uint8_t*)"\r\n");
		USART2_write((uint8_t*)("\033[96m\r\nIf you have not created a user on the app, create one.\033[0m"));
